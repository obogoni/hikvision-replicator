...
- **Numbers**: 224 → 191 integration tests. 34 deleted, 11 relocated into the two contract classes, 1 added (the deterministic mapping test), 7 use-case tests strengthened with a `detail` assertion. Unit tests untouched at 282. No assertion was lost.
